...
# Specifications
#--------------
bond_file = 'C:\Users\VO28885\Desktop\Python\glass_topology_stress_bond.txt'
coord_file = 'C:\Users\VO28885\Desktop\Python\coords_glass_all.txt'
#bond_file = "./test_stress_data.txt"
#coord_file = './test_coord_data.txt'
flow_dir = 'z_coord'
edge_weight_attr = 'rupture_force' # Value of 3.3 nN is hard-coded into function get_bond_info
algorithm = edmonds_karp # Can also be shortest_augmenting_path or preflow_push
...
cut_height = []
cut_edges_all = []
for delta in np.arange(0.1,30,0.25):
...
pickle.dump(cut_values, open('center_void_quartz_cutvalue_ek-z.p','wb'))
pickle.dump(cut_height, open('center_void_quartz_fractureheight_ek-z.p','wb'))
pickle.dump(cut_freq, open('center_void_quartz_edgefreq_ek-z.p','wb'))
pickle.dump(cut_edges_all, open('center_void_quartz_cutedges_ek-z.p','wb'))
